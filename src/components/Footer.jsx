...
const Footer = () => {
  ...
  return (
    <div id='footer' className='pb-[30px] px-5'>
                    ...
                    {FOOTER_LIST.map((obj , i) => (
                        <div key={i} className='flex flex-col gap-4'> 
                             ...
                             <ul className='flex flex-col gap-4'>
                                {obj.list.map((item , i) => (
                                     <li key={i}><a href={item.link} className='text-white opacity-70 duration-300 ease-linear hover:text-sky-blue hover:opacity-100'>{item.item}</a></li>          
                                ))}
                                </ul>
                             </div>
