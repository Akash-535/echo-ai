        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-12 md:gap-4">
          {COUNTER_LIST.map((obj, i) => (
            <div
              ...
              <p className="text-5xl font-semibold leading-custom-3xl max-lg:text-4xl max-md:text-3xl max-sm:text-2xl">
              ...
              <p
                className={`mt-2 opacity-80 text-base mx-auto text-center max-sm:text-sm ${
