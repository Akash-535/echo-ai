    ...
    return (
        <div className='pt-3.5 overflow-hidden min-[1921px]:max-w-[1920px] mx-auto'>
            <div className='container flex justify-between items-center'>
                ...
                <div className={`flex gap-6 max-lg:flex-col max-lg:justify-center max-lg:items-center max-lg:fixed max-lg:top-0 max-lg:w-full max-lg:h-full max-lg:bg-blue-900 duration-300 ease-linear z-10 ${open ? 'max-lg:left-0' : 'max-lg:left-full'}`}>
                ...
                <div onClick={toggleSidebar} className='z-[15] flex-col gap-1 lg:hidden flex'>
                    ...
                    <span className={`${open ? 'w-8 h-1 bg-gradient-to-r from-lite-blue to-sky-blue -translate-x-10 opacity-0 duration-300 ease-linear' : 'w-8 h-1 bg-gradient-to-r from-lite-blue to-sky-blue duration-700 ease-linear rounded'}`}></span>
