    ...
    return (
        <div className='pt-3.5 overflow-hidden min-[1921px]:max-w-[1920px] mx-auto'>
            <div className='container flex justify-between items-center'>
                ...
                <div className={`flex gap-6 max-lg:flex-col max-lg:justify-center max-lg:items-center ${open ? 'max-lg:z-10 max-lg:translate-x-0 max-lg:bg-blue-900 max-lg:fixed max-lg:top-0 max-lg:left-0 max-lg:h-full max-lg:w-full duration-500 ease-linear blur-[80%] justify-center items-center' : 'max-lg:-left-full max-lg:hidden duration-500 ease-linear'}`}>
                ...
                <div onClick={toggleSidebar} className='z-[15] flex-col gap-1 lg:hidden flex'>
                    ...
                    <span className={`${open ? 'w-8 h-1 bg-gradient-to-r from-lite-blue to-sky-blue -translate-x-10 opacity-0 duration-1000 ease-linear' : 'w-8 h-1 bg-gradient-to-r from-lite-blue to-sky-blue duration-700 ease-linear rounded'}`}></span>
